...
Clean routing decisions and backend selection logic
...
The health CLI command calls into Krypton. All entropy comes from the OS RNG via the rand crate. No custom RNG or proprietary entropy engine is implemented here.
